...
const Contact: React.FC = () => {
  // Controlled fields for name, email and message
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .send(
        "service_jf8hf1i", // replace with your EmailJS service ID
          "template_0kbtkak", // replace with your EmailJS template ID
          templateParams,
          "LnCVBnebCCyv3LmqB" // replace with your EmailJS public key
      )
      .then(
        (result) => {
            ...
            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="w-full bg-orange-600 text-white px-6 py-3 font-xl rounded-md"
                  >
                    Send Message
                  </button>
                </div>
